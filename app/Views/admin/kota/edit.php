    ...
    <div class="card-body">
        <form action="<?= base_url('admin/updateKota/' . $kota['id']); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_kota" name="nama_kota" value="<?= $kota['kota']; ?>" aria-describedby="emailHelp" required>
            ...
            <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="harga" name="harga" value= "<?= $kota['hargaOngkir']; ?>" required>
                </div>
